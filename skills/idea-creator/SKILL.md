...
- **REVIEWER_MODEL = `gpt-5.6-sol`** — Model used via Codex MCP for brainstorming and review. Must be an OpenAI model (e.g., `gpt-5.6-sol`, `o3`, `gpt-4o`).
...
2. **Critical review**: Use GPT-5.6-sol via `mcp__codex__codex-reply` (same thread):
   ```
