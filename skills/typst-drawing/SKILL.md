---
name: typst-drawing
description: Typst + CeTZ reference for figures, diagrams, and plots — page setup, packages, math notation, citations, functional idioms, content helpers, CeTZ drawing rules/gotchas, and cetz-plot charts. Use when editing .typ files, drawing or laying out figures/diagrams in Typst or CeTZ, or making Typst plots/charts (typst 画图/作图/绘图).
---
