...
description: "Autonomously improve a generated paper via GPT-5.6-sol max review → implement fixes → recompile, for 2 rounds. Use when user says \"改论文\", \"improve paper\", \"论文润色循环\", \"auto improve\", or wants to iteratively polish a generated paper."
...
Send the full paper text AND compiled PDF to GPT-5.6-sol max:
...
# /kill-argument runs two fresh-thread codex 5.5 max calls and writes
...
<details>
<summary>GPT-5.6-sol max Review (Round 1)</summary>
...
<details>
<summary>GPT-5.6-sol max Review (Round 2)</summary>
